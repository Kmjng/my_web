            ...
            <div className="resume__inner">
                <div className="education">
                    ...
                    <div className="education_1">
                        <div>🏫 2024.02.~ 2024.08. ITWILL 빅데이터 융합 머신러닝 전문가 양성과정 45기 </div>
                ...
                <div className="experience">
                    ...
                    <div className="experience_1">
                        <div>🏢 2023.03.~2023.12. A Barristor Company (석사후연구원) </div>
                    </div>
                </div>
                ...
                <div className="skills">
                    ...
                    <div className="skills_1">
                        ...
                        <div className="skill-item">
                            <strong className="skn">🗝️ Git, github  </strong>
                            <span className="skc"></span>
                        </div>
                        <div className="skill-item">
                        ...
                        <div className="skill-item">
                            <strong className="skn">🗝️ DL Framework - Tensorflow, Pytorch </strong>
                            <span className="skc"></span>
                        </div>
                        <div className="skill-item">
